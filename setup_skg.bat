...
if not exist "podcast_engine\coqui\reference_audio" mkdir "podcast_engine\coqui\reference_audio"
if not exist "podcast_engine\output\segments" mkdir "podcast_engine\output\segments"
if not exist "podcast_engine\output\temp" mkdir "podcast_engine\output\temp"
if not exist "podcast_engine\output\podcasts" mkdir "podcast_engine\output\podcasts"
if not exist "podcast_engine\output\audiobooks" mkdir "podcast_engine\output\audiobooks"
if not exist "podcast_engine\output\acx" mkdir "podcast_engine\output\acx"
if not exist "podcast_engine\assets" mkdir "podcast_engine\assets"

REM Check if SKG core exists
if not exist "podcast_engine\skg\skg_core.json" (
...
echo    - podcast_engine\assets\transition_sting.mp3
echo.
